...
SHOW_COURSES_TO_ANONYMOUS_USERS = ENV_TOKENS.get(
...
COLARAZ_ALLOWED_SUB_PATHS = ENV_TOKENS.get(
    'COLARAZ_ALLOWED_SUB_PATHS',
    COLARAZ_ALLOWED_SUB_PATHS
)
...
COLARAZ_DOMAIN_PROTOCOL = ENV_TOKENS.get(
    'COLARAZ_DOMAIN_PROTOCOL',
    COLARAZ_DOMAIN_PROTOCOL
)
COLARAZ_SUB_DOMAIN = ENV_TOKENS.get(
    'COLARAZ_SUB_DOMAIN',
    COLARAZ_SUB_DOMAIN
)
...
COLARAZ_JOB_ALERTS = ENV_TOKENS.get(
    'COLARAZ_JOB_ALERTS',
    COLARAZ_JOB_ALERTS
)
