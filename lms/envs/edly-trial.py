...
ENV_CUSTOMER_NAME_IDENTIFIER = ENV_TOKENS.get('CUSTOMER_NAME_IDENTIFIER', '')
if ENV_CUSTOMER_NAME_IDENTIFIER != '':
    CUSTOMER_NAME_IDENTIFIER = '.' + ENV_CUSTOMER_NAME_IDENTIFIER

CELERY_DEFAULT_EXCHANGE = 'edx.{0}core'.format(QUEUE_VARIANT) + CUSTOMER_NAME_IDENTIFIER

HIGH_PRIORITY_QUEUE = 'edx.{0}core.high'.format(QUEUE_VARIANT) + CUSTOMER_NAME_IDENTIFIER
DEFAULT_PRIORITY_QUEUE = 'edx.{0}core.default'.format(QUEUE_VARIANT) + CUSTOMER_NAME_IDENTIFIER
HIGH_MEM_QUEUE = 'edx.{0}core.high_mem'.format(QUEUE_VARIANT) + CUSTOMER_NAME_IDENTIFIER
