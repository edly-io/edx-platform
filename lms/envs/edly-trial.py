...
CELERY_DEFAULT_EXCHANGE = 'edx.{0}core.trial'.format(QUEUE_VARIANT)

HIGH_PRIORITY_QUEUE = 'edx.{0}core.high.trial'.format(QUEUE_VARIANT)
DEFAULT_PRIORITY_QUEUE = 'edx.{0}core.default.trial'.format(QUEUE_VARIANT)
HIGH_MEM_QUEUE = 'edx.{0}core.high_mem.trial'.format(QUEUE_VARIANT)
