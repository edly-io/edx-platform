...
ALLOWED_SITE_CONFIGURATIONS_OVERRIDE = [
    ...
    'MOBILE_APP_CONFIG', 'STUDENT_FILEUPLOAD_MAX_SIZE'
]
...
TWO_FA_ENFORCE = True
TWO_FA_CODE_EXPIRY_SECONDS = 600
TWO_FA_ENFORCE_BYPASS_SUPERUSER = True
TWO_FA_RESEND_COOLDOWN_SECONDS = 180
TWO_FA_ATTEMPTS_MAX_LIMIT = 3
