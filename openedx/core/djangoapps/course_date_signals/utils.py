...
MIN_DURATION = timedelta(weeks=getattr(settings, 'COURSE_ACCESS_DURATION_MIN_WEEKS', 12))
MAX_DURATION = timedelta(weeks=getattr(settings, 'COURSE_ACCESS_DURATION_MAX_WEEKS', 18))
