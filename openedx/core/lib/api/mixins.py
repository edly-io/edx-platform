...
# Re-exported for existing import sites; new code should import it from
# edx_rest_framework_extensions.mixins directly.
from edx_rest_framework_extensions.mixins import StandardizedErrorMixin  # pylint: disable=unused-import
